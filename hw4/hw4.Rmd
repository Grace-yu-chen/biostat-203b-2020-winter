...
```{r}
study_subjects %>%
  semi_join(study_admissions_ccu, by = "subject_id") %>%
  print() -> study_subjects_ccu
study_subjects %>%
  semi_join(study_admissions_csru, by = "subject_id") %>%
  print() -> study_subjects_csru
study_subjects %>%
  semi_join(study_admissions_micu, by = "subject_id") %>%
  print() -> study_subjects_micu
study_subjects %>%
  semi_join(study_admissions_sicu, by = "subject_id") %>%
  print() -> study_subjects_sicu
study_subjects %>%
  semi_join(study_admissions_tsicu, by = "subject_id") %>%
  print() -> study_subjects_tsicu
```
