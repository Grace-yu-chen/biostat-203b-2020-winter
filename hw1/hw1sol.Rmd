...
Do **not** put this text file `pride_and_prejudice.txt` in Git. Using a `for` loop, how would you tabulate the number of times each of the four characters is mentioned?
  ...
  **SOLUTION**
  ...
  for (name in Elizabeth Jane Lydia Darcy){
    do
      echo $name
      grep -o $name /Users/yuchen/Desktop/UCLA_courses/203B/pride_and_prejudice.txt | wc -l
      echo
    done
  }
  ```
...
0. What's the difference between the following two commands?
    ...
    ```
  **SOLUTION**
  The first command writes 'hello, world' into a text file named test1 and covers the contents of the file, while the second command appends 'hello, world' to the text file named test2 without changing any initial contents.
